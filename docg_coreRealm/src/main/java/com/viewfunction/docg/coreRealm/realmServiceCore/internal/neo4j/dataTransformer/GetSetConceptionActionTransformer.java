...
public class GetSetConceptionActionTransformer implements DataTransformer<Set<ConceptionAction>>{

    private GraphOperationExecutor workingGraphOperationExecutor;

    public GetSetConceptionActionTransformer(GraphOperationExecutor workingGraphOperationExecutor){
