...
public class GetSingleGeospatialScaleEventTransformer implements DataTransformer<GeospatialScaleEvent> {

    private GraphOperationExecutor workingGraphOperationExecutor;
    private String geospatialRegionName;

    public GetSingleGeospatialScaleEventTransformer(String geospatialRegionName, GraphOperationExecutor workingGraphOperationExecutor){
        this.workingGraphOperationExecutor = workingGraphOperationExecutor;
        this.geospatialRegionName = geospatialRegionName;
    }

    @Override
    public GeospatialScaleEvent transformResult(Result result) {
        if(result.hasNext()){
