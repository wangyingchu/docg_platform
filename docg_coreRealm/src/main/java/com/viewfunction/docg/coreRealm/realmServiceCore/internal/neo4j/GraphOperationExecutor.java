...
public class GraphOperationExecutor<T> implements AutoCloseable{
    ...
    private String databaseName = PropertiesHandler.getPropertyValue(PropertiesHandler.NEO4J_DEFAULT_DATABASE_NAME) != null ?
            PropertiesHandler.getPropertyValue(PropertiesHandler.NEO4J_DEFAULT_DATABASE_NAME) : null;
