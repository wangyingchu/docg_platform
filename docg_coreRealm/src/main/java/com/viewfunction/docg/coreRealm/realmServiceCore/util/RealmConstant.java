...
public interface RealmConstant {
    ...
    public final String RelationKind_AttributesViewKindRelationClass="DOCG_RelationContainsViewKindIs";
    ...
    public final String _actionImplementationClassProperty = "DOCG_ActionImplementationClass";
    ...
    public final String _GeospatialGeometryComment="DOCG_GS_GeometryComment";
    public final String _GeospatialGeometryFormerName="DOCG_GS_GeometryFormerName";
    ...
    public final String RelationKindsAttributesSystemInfoStaticClass="DOCG_Static_RelationKindsAttributesSystemInfo";
}