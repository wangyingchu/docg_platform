        ...
        if(this.getEntityUID() != null) {
            ...
            try{
                ...
                if(entitiesSpatialContentDataMap != null){
                    ...
                    return GeospatialCalculateUtil.getConceptionEntitiesByUIDs(workingGraphOperationExecutor,getGraphOperationExecutorHelper().getGlobalGraphOperationExecutor(),matchedEntityUIDSet);
                }
            }finally {
    ...
    default List<GeospatialScaleEntity> getSpatialPredicateMatchedGeospatialScaleEntities(SpatialScaleLevel spatialScaleLevel, SpatialPredicateType spatialPredicateType,
        ...
        if(this.getEntityUID() != null) {
            ...
            try{
                ...
                Map<String,String> entitiesSpatialContentDataMap = GeospatialCalculateUtil.getGeospatialScaleEntityContentMap(workingGraphOperationExecutor,geospatialScaleGradeValue,attributesParameters,spatialScaleLevel);
                if(entitiesSpatialContentDataMap != null){
                    List<String> entityUIDList = new ArrayList<>();
                    entityUIDList.add(this.getEntityUID());
                    Map<String,String> geospatialScaleContentMap = GeospatialCalculateUtil.getGeospatialScaleContent(workingGraphOperationExecutor,spatialScaleLevel,entityUIDList);
                    Set<String> matchedEntityUIDSet = GeospatialCalculateUtil.spatialPredicateFilterWKTsCalculate(
