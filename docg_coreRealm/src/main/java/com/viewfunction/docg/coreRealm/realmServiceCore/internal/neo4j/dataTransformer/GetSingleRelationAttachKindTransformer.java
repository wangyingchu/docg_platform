...
public class GetSingleRelationAttachKindTransformer implements DataTransformer<RelationAttachKind>{

    private GraphOperationExecutor workingGraphOperationExecutor;
    private String currentCoreRealmName;

    public GetSingleRelationAttachKindTransformer(String currentCoreRealmName,GraphOperationExecutor workingGraphOperationExecutor){
        this.currentCoreRealmName= currentCoreRealmName;
        this.workingGraphOperationExecutor = workingGraphOperationExecutor;
    }

    @Override
    public RelationAttachKind transformResult(Result result) {
        if(result.hasNext()){
