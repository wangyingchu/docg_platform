...
public interface GeospatialScaleCalculable {
    ...
    public boolean isSpatialPredicateMatchedWith(String targetConceptionEntityUID,SpatialScaleLevel spatialScaleLevel) throws CoreRealmServiceRuntimeException;
