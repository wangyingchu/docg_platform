...
LIB="$WORKINGDIR/docg_analysisProvider-1.0.0.jar":"$LIB"
#echo $LIB
...
"java" -XX:+UseG1GC -XX:+DisableExplicitGC -Xmx10G -Xrs -cp $EXTENDCLASSPATH:$LIB "com.viewfunction.docg.analysisProvider.providerApplication.AnalysisProviderApplicationLauncher"
