package com.viewfunction.docg.dataFabric.consoleApplication.util;
...
public class ApplicationLauncherUtil {
    ...
    public static String getDefaultApplicationFeatureName(){
        return getApplicationInfoPropertyValue("applicationFeatureName");
    }
    ...
    public static void printApplicationConsoleBanner(){
        ...
        bannerStringBuffer.append("Running Feature: "+getDefaultApplicationFeatureName());
        bannerStringBuffer.append("\n\r");
        String echo8="==================================================================";
        bannerStringBuffer.append(echo8);
