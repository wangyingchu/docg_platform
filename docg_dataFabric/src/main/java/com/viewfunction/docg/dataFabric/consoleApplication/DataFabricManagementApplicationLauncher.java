...
import com.viewfunction.docg.dataFabric.consoleApplication.exception.ApplicationInitException;
import com.viewfunction.docg.dataFabric.consoleApplication.feature.BaseApplication;
import com.viewfunction.docg.dataFabric.consoleApplication.util.ApplicationLauncherUtil;
...
public class DataFabricManagementApplicationLauncher {
    ...
    private static Logger logger = LoggerFactory.getLogger(DataFabricManagementApplicationLauncher.class);
