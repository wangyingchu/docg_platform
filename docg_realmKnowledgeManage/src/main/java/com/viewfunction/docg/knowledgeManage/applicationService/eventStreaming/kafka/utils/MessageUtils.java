...
public class MessageUtils {
    ...
    public static void main(String[] args){
        try {
            String str = "{\"data\":{\"birth_day\":7,\"birth_month\":6},\"errcode\":0,\"msg\":\"ok\",\"ret\":[0,1,2,3]}";
            ...
            while(fields.hasNext()){
                ...
                JsonNode currentChildNode=root.path(fieldName);
                System.out.println(currentChildNode.isValueNode());
                //System.out.println(currentChildNode.isTextual());
                System.out.println(currentChildNode.isArray());
                System.out.println(currentChildNode.isContainerNode());
                System.out.println(currentChildNode);

                if(currentChildNode.isArray()){
                    System.out.println("XXX");
                    System.out.println(currentChildNode.isInt());
                    System.out.println("XXX");
                    ArrayNode arrayNode=(ArrayNode)currentChildNode;
            ...
            String str2 ="{\"birth_day\":7}";
            JsonNode root2 = mapper.readTree(str2);
            System.out.println(root2.getFieldNames());
            */
        }catch (IOException e){}
    }
}