...
LIB="$WORKINGDIR/docg_realmKnowledgeManage-0.5.jar":"$LIB"
#echo $LIB
...
"java" -XX:+UseG1GC -XX:+DisableExplicitGC -Xmx10G -Xrs -cp $EXTENDCLASSPATH:$LIB "com.viewfunction.docg.knowledgeManage.consoleApplication.KnowledgeManagementApplicationLauncher"
