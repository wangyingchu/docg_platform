...
import com.viewfunction.docg.dataCompute.consoleApplication.exception.ApplicationInitException;
...
public class DataComputeApplicationLauncher {
    ...
    private static Logger logger = LoggerFactory.getLogger(DataComputeApplicationLauncher.class);
