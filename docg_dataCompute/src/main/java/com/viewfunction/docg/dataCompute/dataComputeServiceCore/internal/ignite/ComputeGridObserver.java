package com.viewfunction.docg.dataCompute.dataComputeServiceCore.internal.ignite;
...
public class ComputeGridObserver implements AutoCloseable {
    ...
    public DataSliceMetaInfo createGridDataSlice(String dataSliceName, String dataSliceGroup,
    ...
    public DataSliceMetaInfo createPerUnitDataSlice(String dataSliceName, String dataSliceGroup,
                                                    Map<String, DataSlicePropertyType> propertiesDefinitionMap,
                                                    List<String> primaryKeysList) throws DataSliceExistException, DataSlicePropertiesStructureException {
    ...
    public void eraseDataSlice(String dataSliceName) {
        this.igniteClient.destroyCache(dataSliceName);
    }

    public void emptyDataSlice(String dataSliceName) {
    ...
    private DataSliceMetaInfo createDataSlice(String dataSliceName, String dataSliceGroup, Map<String, DataSlicePropertyType> propertiesDefinitionMap, List<String> primaryKeysList, String templateType) throws DataSliceExistException, DataSlicePropertiesStructureException {
        ...
        ClientCacheConfiguration clientCacheConfiguration = igniteCache.getConfiguration();
        DataSliceMetaInfo dataSliceMetaInfo = new DataSliceMetaInfo();
        dataSliceMetaInfo.setDataSliceName(clientCacheConfiguration.getName());
        dataSliceMetaInfo.setSliceGroupName(clientCacheConfiguration.getSqlSchema());
        dataSliceMetaInfo.setPrimaryDataCount(igniteCache.size(CachePeekMode.PRIMARY));
        dataSliceMetaInfo.setBackupDataCount(igniteCache.size(CachePeekMode.BACKUP));
        dataSliceMetaInfo.setTotalDataCount(igniteCache.size(CachePeekMode.ALL));
        dataSliceMetaInfo.setStoreBackupNumber(clientCacheConfiguration.getBackups());
        CacheMode currentStoreCacheMode = clientCacheConfiguration.getCacheMode();
        switch (currentStoreCacheMode) {
            case PARTITIONED -> dataSliceMetaInfo.setDataStoreMode(DataSliceStoreMode.Grid);
