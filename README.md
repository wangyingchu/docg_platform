...
- ####  以 DDD 领域驱动设计为核心的 <span style="color:#0074D9;">领域模型构建功能</span>

- #### 数字孪生的 <span style="color:#0074D9;">领域知识图谱</span>

- ####  针对任何领域数据对象的 <span style="color:#0074D9;">关联性数据分析功能</span>

- ####  针对任何领域数据对象的 <span style="color:#0074D9;">时空一体化分析功能</span>
...
[DOCG 数据分析平台领域模型详细说明]: Documentation/modeling/modeling.md
[DOCG 数据分析平台领域模型 SDK 详细说明]: Documentation/coreRealm/JavaSDK_API.md
