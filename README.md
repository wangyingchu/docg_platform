...
<center>建筑工程建设项目相关领域知识图谱</center>
...
DOCG 数据分析平台通过核心领域模型建模创建的数据网络，天然就是一个面向特定业务目标的行业领域知识图谱。





<img src="Documentation/intro/documentPic/domainStructure1.png" style="zoom:50%;" />

<center>建筑工程建设项目相关领域知识图谱</center>

<img src="Documentation/intro/documentPic/domainStructure2.png" style="zoom:50%;" />
