package com.viewfunction.docg.analysisMotor.client;
...
import com.viewfunction.docg.analysisMotor.client.exception.AnalyseResponseFormatException;
...
import com.viewfunction.docg.analysisMotor.communication.CommunicationActor;
...
public class AnalysisEngineClient {
    ...
    public AnalysisEngineClient(String hostName, int hostPort){
    ...
    public void closeSession() throws EngineClientInitException {
        if(actorSystem != null){
            try {
                Thread.sleep(1000);
    ...
    public void sendAnalyseRequest(AnalyseRequest analyseRequest, AnalyseResponseCallback analyseResponseCallback, int timeoutSecond) throws EngineClientInitException, AnalysisEngineRuntimeException {
    ...
    public void sendAnalyseRequest(AnalyseRequest analyseRequest) throws EngineClientInitException,AnalysisEngineRuntimeException{
