...
import com.viewfunction.docg.analysisMotor.feature.ignite.memoryTable.MemoryTablePropertyType;
...
public class MemoryTableUtil {
    ...
    public static String buildMemoryTableStructureSQL(Map<String, MemoryTablePropertyType> fieldsDefinitionMap, List<String> primaryKeysList){
